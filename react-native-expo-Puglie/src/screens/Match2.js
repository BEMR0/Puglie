    ...
    return (
        <React.Fragment>
            <View style={styles.contenedorssss} >
                ...
                <Text style={{ fontSize: 26, fontWeight: 'bold', color: '#9A0680', marginTop: 80 }}>CANELA</Text>

                <Image source={{
                    uri: 'https://i.pinimg.com/564x/54/f6/e1/54f6e1da4b807b5ff3722eab877a6512.jpg',
                    cache: 'only-if-cached'
                }} style={{ width: 280, height: 280, borderRadius: 40, marginTop: 5 }} />


                <View style={{ alignItems: 'flex-start', marginLeft: -60, padding: 5, }}>

                    <Text style={{ fontSize: 18, marginTop: 10, borderBottomColor: '#FF87CA', textAlign: 'left', color: '#3F0071' ,}} >RAZA: PUG </Text>
                    <Text style={{ fontSize: 18, color: '#3F0071', marginVertical: 5 }} >EDAD: 11 MESES</Text>
                    ...
                    <Text style={{ fontSize: 18, color: '#3F0071' , marginVertical: 5}} >DUEÑO: ROXANA MOSQUERA</Text>
